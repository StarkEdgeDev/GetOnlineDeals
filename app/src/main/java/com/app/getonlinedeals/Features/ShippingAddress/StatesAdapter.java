...
public class StatesAdapter extends BaseAdapter implements SpinnerAdapter {

    ArrayList<CountriesListModel.Provinces> countries;
    Context context;
    private BaseCallBack<Integer> callBack;

    public StatesAdapter(Context context, ArrayList<CountriesListModel.Provinces> countries, BaseCallBack<Integer> callBack) {
